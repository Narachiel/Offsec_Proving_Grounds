###### tags: `Offsec` `PG Practice` `Easy` `Windows` # Helpdesk
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Search`manageengine servicedesk plus default credentials`candefualt credential`administrator/administrator`
[CVE-2014-5301.py](https://github.com/PeterSufliarsky/exploits/blob/master/CVE-2014-5301.py),use
```
┌──(kali㉿kali)-[~/pgplay]
...
``` log in`Administrator`,`C:\Users\Administrator\Desktop`get proof.txt
```
