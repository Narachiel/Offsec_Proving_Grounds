###### tags: `Offsec` `PG Practice` `Easy` `Windows` # Algernon
```
┌──(kali㉿kali)-[~/pgplay]
...
``` google[edb-49216](https://www.exploit-db.com/exploits/49216),
```
HOST='192.168.204.65'
PORT=17001
LHOST='192.168.45.242'
LPORT=9001
``` Open nc,.pywait for reverse shellget Administrator,`C:\Users\Administrator\Desktop`get proof.txt
```
┌──(kali㉿kali)-[~/pgplay]
