###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # pyLoader
```
┌──(kali㉿kali)-[~/pgplay]
...
``` SearchPyLoad exploit[CVE-2023-0297](https://github.com/JacobEbben/CVE-2023-0297/tree/main),use,Open nc,get root,/rootget proof.txt
```
┌──(kali㉿kali)-[~/pgplay]
