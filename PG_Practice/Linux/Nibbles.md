###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # Nibbles
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Search[edb-50847](https://www.exploit-db.com/exploits/50847),Firstusewhoamifindcan
```
┌──(kali㉿kali)-[~/pgplay]
...
postgres
``` usereverseshell,`/home/wilson`pathget local.txt
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Checkbinaries,find,Refer to[GTFOBins](https://gtfobins.github.io/gtfobins/find/#suid),get proof.txt in /root
```
