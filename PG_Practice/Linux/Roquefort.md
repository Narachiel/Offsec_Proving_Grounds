###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # Roquefort
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Search[edb-49383](https://www.exploit-db.com/exploits/49383),First`http://192.168.176.67:3000`use
```
Username: admin1
...
...
``` reverse,wait for reverse shell
```
┌──(kali㉿kali)-[~/pgplay]
