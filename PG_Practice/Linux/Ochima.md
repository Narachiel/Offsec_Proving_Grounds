###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # Ochima
```
┌──(kali㉿kali)-[~/pgplay]
...
``` google [Maltrail-v0.53-RCE](https://github.com/josephberger/Maltrail-v0.53-RCE),use,wait for reverse shell,`/home/snort`get local.txt
```
┌──(kali㉿kali)-[~/pgplay]
...
...
```.shreverse,get root,/rootget proof.txt
```
┌──(kali㉿kali)-[~/pgplay]
