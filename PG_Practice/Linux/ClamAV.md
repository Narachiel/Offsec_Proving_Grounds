###### tags: `Offsec` `PG Practice` `Easy` `Linux` # ClamAV
```
┌──(kali㉿kali)-[~/pgplay]
...
``` google[CVE-2007-4560](https://github.com/0x1sac/ClamAV-Milter-Sendmail-0.91.2-Remote-Code-Execution/blob/main/exploit.c),downloadreverseshell
```
┌──(kali㉿kali)-[~/pgplay]
...
[+] Connected to 192.168.166.42:25
[+] Payload sent!
``` wait for reverse shellobtainroot,/rootget proof.txt
```
whoami
root
cat proof.txt
