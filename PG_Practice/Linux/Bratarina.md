###### tags: `Offsec` `PG Practice` `Easy` `Linux` # Bratarina
```
┌──(kali㉿kali)-[~/pgplay]
...
``` google[edb-47984](https://www.exploit-db.com/exploits/47984),445,use445portreverse(80,)
```
┌──(kali㉿kali)-[~/pgplay]
...
``` wait for reverse shellfindroot,/rootproof.txt
```
