###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # Catto
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Check`http://192.168.233.139:30330/static/`,can`http://192.168.233.139:30330/new-server-config-mc`,`WallAskCharacter305`
```
...
``` Click`http://192.168.233.139:30330/minecraft`,`sabel`、`yvette`、`zahara`、`sybilla`、`marcus`、`tabbatha`、`tabby`
```
...
``` use`marcus/WallAskCharacter305`sshlogin,`/home/marcus`get local.txt
```
┌──(kali㉿kali)-[~/pgplay]
