###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # Snookums
```
┌──(kali㉿kali)-[~/pgplay]
...
|     Invalid message"
|_    HY000
``` Search[SimplePHPGal-RCE.py](https://github.com/beauknowstech/SimplePHPGal-RCE.py),use
```
┌──(kali㉿kali)-[~/pgplay]
...
...
``` use[CVE-2021-4034](https://github.com/joeammond/CVE-2021-4034/blob/main/CVE-2021-4034.py),get proof.txt in /root,`/home/micheal`get local.txt
```
