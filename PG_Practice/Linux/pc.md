###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # pc
```
┌──(kali㉿kali)-[~/pgplay]
...
...
``` google`rpcpy-exploit`[CVE-2022-35411](https://github.com/ehtec/rpcpy-exploit/tree/main),`exec_command`reverse command,
```
┌──(kali㉿kali)-[~/pgplay]
