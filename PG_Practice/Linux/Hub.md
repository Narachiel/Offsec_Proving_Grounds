###### tags: `Offsec` `PG Practice` `Easy` `Linux` # Hub
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Check`192.168.204.25:8082`googleSearch[edb-51550](https://www.exploit-db.com/exploits/51550)
```
# 51550.py
...
``` Open nc,usepoc,get root,shelluse,shell
```
┌──(kali㉿kali)-[~/pgplay]
