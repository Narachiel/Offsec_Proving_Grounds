###### tags: `Offsec` `PG Practice` `Hard` `Linux` # Sirol
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Search[CVE-2019-7609](https://github.com/LandGrey/CVE-2019-7609/blob/master/CVE-2019-7609-kibana-rce.py),use`/home/trent`get local.txt
```
┌──(kali㉿kali)-[~/pgplay]
...
...
``` then use [Docker Breakout / Privilege Escalation](https://book.hacktricks.xyz/linux-hardening/privilege-escalation/docker-security/docker-breakout-privilege-escalation#privileged),`fdisk -l`canuse
```
