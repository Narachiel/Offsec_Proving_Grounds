###### tags: `Offsec` `PG Practice` `Easy` `Linux` # Pebbles
```
┌──(kali㉿kali)-[~/pgplay]
...
===============================================================
``` google[edb-41239](https://vk9-sec.com/zoneminder-1-291-30-exploitation-multiple-vulnerabilities/),canuse`sql injection`burpsuite
```
...
``` Check`http://192.168.158.52:3305/shell.php?cmd=id`get ```
