###### tags: `Offsec` `PG Practice` `Easy` `Linux` # Astronaut
```
┌──(kali㉿kali)-[~/pgplay]
...
``` google[CVE-2021-21425
](https://github.com/CsEnox/CVE-2021-21425/blob/main/exploit.py),downloadreverseshell,
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Open ncwait for reverse shell,binaries,`/usr/bin/php7.4`
```
┌──(kali㉿kali)-[~/pgplay]
...
/usr/bin/php7.4
/usr/bin/gpasswd
``` Check[GTFOBins](https://gtfobins.github.io/gtfobins/php/#suid),`/root`pathobtainproof.txt
```
