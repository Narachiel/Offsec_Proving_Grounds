###### tags: `Offsec` `PG Practice` `Easy` `Linux` # Exghost
```
┌──(kali㉿kali)-[~/pgplay]
...
``` can[CVE-2022-22947](https://www.exploit-db.com/exploits/50911)
Firstdownload,`image.jpg`,Open nc,then use `curl`
```
┌──(kali㉿kali)-[~/pgplay]
...
...
``` use[CVE-2021-4034](https://github.com/joeammond/CVE-2021-4034/blob/main/CVE-2021-4034.py)get root,/rootproof.txt
```
