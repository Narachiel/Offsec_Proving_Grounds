###### tags: `Offsec` `PG Practice` `Easy` `Linux` # Levram
```
┌──(kali㉿kali)-[~/pgplay]
...
``` google[edb-50640](https://www.exploit-db.com/exploits/50640)
```
┌──(kali㉿kali)-[~/pgplay]
...
``` findproject,`admin/admin`loginFirstproject ![Levram_1.png](picture/Levram_1.png) get shell`/home/app`get local.txt
```
┌──(kali㉿kali)-[~/pgplay]
...
...
``` Search[GTFOBins](https://gtfobins.github.io/gtfobins/python/#capabilities),get proof.txt in /root
```
