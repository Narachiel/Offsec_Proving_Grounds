###### tags: `Offsec` `PG Practice` `Easy` `Linux` # Twiggy
```
┌──(kali㉿kali)-[~/pgplay]
...
``` google `zeromq zmtp 2.0 exploit`can[CVE-2020-11652](https://github.com/Al1ex/CVE-2020-11652.git),First`salt`
```
┌──(kali㉿kali)-[~/pgplay/CVE-2020-11652]
└─$ sudo pip3 install salt==3007.0rc1
``` obtain`/etc/passwd`payloaduse(warning)
```
┌──(kali㉿kali)-[~/pgplay/CVE-2020-11652]
...
``` wait for reverse shellcan getroot,/rootget proof.txt
```
