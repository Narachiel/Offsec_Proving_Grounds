###### tags: `Offsec` `PG Practice` `Intermediate` `Linux` # Crane
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Check`192.168.219.146`canlogin,then use `admin/admin`login,Check`http://192.168.219.146/index.php?module=Home&action=About`can`Version 7.12.3 ` ![Crane_1.png](picture/Crane_1.png) googleSearchcan[CVE-2022-23940](https://github.com/manuelz120/CVE-2022-23940)use,use[pyenv](https://www.kali.org/docs/general-use/using-eol-python-versions/)python`3.8.18`
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Check`sudo -l`,Check[GTFOBins](https://gtfobins.github.io/gtfobins/service/#shell),get root`/root`get proof.txt
```
