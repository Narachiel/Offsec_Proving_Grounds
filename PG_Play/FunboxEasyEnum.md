###### tags: `Offsec` `PG Play` `Easy` `Linux` # FunboxEasyEnum
```
┌──(kali㉿kali)-[~/pgplay]
...
Finished
===============================================================
``` Check `http://192.168.203.132/mini.php` can get an upload page, upload a reverse shell; after checking `http://192.168.203.132/shell.php`, in `/var/www` path get local.txt
```
┌──(kali㉿kali)-[~/pgplay]
