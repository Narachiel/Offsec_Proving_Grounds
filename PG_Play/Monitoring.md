###### tags: `Offsec` `PG Play` `Easy` `Linux` # Monitoring(incomplete)
```
┌──(kali㉿kali)-[~/pgplay]
...
``` via80portcan loginpage, Use [accountnagiosadminpasswordadmin](https://support.nagios.com/forum/viewtopic.php?t=544)can loginpage download[CVE-2019–15949](https://github.com/hadrian3689/nagiosxi_5.6.6)
```
┌──(kali㉿kali)-[~/pgplay]
