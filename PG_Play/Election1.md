###### tags: `Offsec` `PG Play` `Easy` `Linux` # Election1
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Check`http://192.168.163.211/robots.txt`
```
admin
wordpress
user
election
``` Only `http://192.168.163.211/election` is accessible; continue with `ffuf`
```
┌──(kali㉿kali)-[~/pgplay]
...
``` Go to `http://192.168.163.211/election/admin/logs/` and download `system.log`
```
[2020-01-01 00:00:00] Assigned Password for the user love: P@$$w0rd@123
[2020-04-03 00:13:53] Love added candidate 'Love'.
[2020-04-08 19:26:34] Love has been logged in from Unknown IP on Firefox (Linux).
``` Use `love/P@$$w0rd@123` to SSH login; in `/home/love` get `local.txt`
```
┌──(kali㉿kali)-[~/pgplay]
